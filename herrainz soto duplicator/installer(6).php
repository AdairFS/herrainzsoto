...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'herrainzsoto_theme_910b1e6601178ba16487_20211104111123_archive.zip';
	const ARCHIVE_SIZE		 = '29803019';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '910b1e6-04111123';
    const SECONDARY_PACKAGE_HASH = 'c22590d-04111123';
	const VERSION			 = '1.4.3';
