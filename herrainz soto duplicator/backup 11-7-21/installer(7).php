...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'herrainzsoto_theme_ea877ee2fb4d846a5444_20211106232405_archive.zip';
	const ARCHIVE_SIZE		 = '74498972';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ea877ee-06232405';
    const SECONDARY_PACKAGE_HASH = '5a123b8-06232405';
	const VERSION			 = '1.4.3';
